# Structure of `uploads_array` from `$_FILES`
...
That modified structure is what `uploads_array` type represents, with the addition that instead of presenting the file information as an array, it is encapsulated in an _UploadStruct_ instance:
